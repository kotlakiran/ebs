 ...
 * 
 */
@WebServiceClient(name = "TestService", targetNamespace = "http://app.com/", wsdlLocation = "http://localhost:2222/ws?wsdl")
    ...
    extends Service
{
    ...
    private final static QName TESTSERVICE_QNAME = new QName("http://app.com/", "TestService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:2222/ws?wsdl");
    ...
    public Test getTestPort() {
        return super.getPort(new QName("http://app.com/", "TestPort"), Test.class);
    }
    ...
    public Test getTestPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://app.com/", "TestPort"), Test.class, features);
    }
